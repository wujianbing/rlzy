...
<!--产品名称-->	
  <div class="layui-form-item">
    ...
    <div class="layui-input-block lae">
      	<input id="t1" type="text" required name="title" lay-verify="required" placeholder="请输入产品名称" autocomplete="off" class="layui-input">
    </div>
  </div>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block lae">
      	<input id="t2" type="text"required name="intro" lay-verify="required" placeholder="请输入产品简介" autocomplete="off" class="layui-input">
    </div>
  </div>
...
layui.use('form', function(){
  ...
  form.on('submit(formDemo)', function(data){
    ...
    $.ajax({
		type : "POST",
		url : "${rlzyPath}/company/saveProduct?companyid=${id}",
		data :$("#form").serialize(),
