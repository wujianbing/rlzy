				...
				<div class="row layui-form">
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input id="oldphone" type="text" value="${rlzyCompany.telephone}" disabled="disabled" autocomplete="off" class="layui-input">
						</div>
					...
					<div class="box2 layui-form"   id="sign_v" style="display:none;">
						...
						<div class="layui-form-item">
						 ...
						 <div class="layui-form-item">
						    ...
						    <input type="text" hidden="hidden" value="${rlzyCompany.id}"  id="inp2">
					...
					<div class="layui-form-item">
						...
						<div class="layui-input-inline">
							<input type="text" autocomplete="off" style="background: #b0afb9;;" value="${rlzyCompany.companyname}" disabled="disabled" class="layui-input">
						</div>
						<div class="layui-form-mid layui-word-aux ChangePassword" onclick="xgma()">修改密码</div>
							...
							<div class="layui-input-inline" style="width: 190px;">
								<input type="password" value="${rlzyCompany.password}" disabled="disabled"  autocomplete="off" class="layui-input">
							</div>
						 ...
						 <div class="layui-form-item">
						    <div class="layui-input-block" style="margin-left: 187px;">
						    	<input type="text" hidden="hidden" value="${rlzyCompany.id}"  id="inp">
...
<script type="text/javascript" src="${ctxStatic }/rlzy/js/account.js" ></script>
