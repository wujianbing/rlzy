...
<script type="text/javascript">
		...
		//zTree初始化
				...
				$('#jstree').treeview({
		            ...
		            onNodeSelected: function(event, treeNode) {
						...
						if(treeNode.level == 1){//level=0 代表公司
							...
							var parent = $("#jstree").treeview('getParent',treeNode);
							$("#companyId").val(parent.id);
							$("#companyName").val(parent.text);
							$("#officeId").val(id);
		  ...
		  function form1(){
			  ...
			  jp.openSaveDialog('新建用户', "${ctx}/sys/user/form?office.id=" + officeId + "&company.id=" + companyId,'800px', '680px');
