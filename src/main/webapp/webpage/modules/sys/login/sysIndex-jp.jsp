...
<nav class="navbar navbar-inverse display-default opnav-navbar navbar-fixed-top" role="navigation">
	<div class="topnav-navbar">
		<div class="navbar-header text-center">
			...
			<a class="navbar-brand J_menuItem" href="${ctx}/home" data-index="0">吴忠人力资源平台</a>
		</div>
	</div>
...
<section id="body-container" class="animation">
	...
	<!-- <div class="footer">
		<div class="pull-left"><a href="http://huaxinzhi.com" target="_blank">http://huaxinzhi.com</a> &copy; 2019-2025</div>
	</div>
 -->
</section>
