...
$(document).ready(function() {
  ...
  function refresh(){
   ...
   function add(){
	  ...
	  //alert(newsModelId);
	  jp.openSaveDialog('新增', "${ctx}/portal/news/form?newsModel.id=" + newsModelId,'1300px', '900px');
   ...
   function edit(id){//没有权限时，不显示确定按钮
	...
	jp.openSaveDialog('编辑', "${ctx}/portal/news/form?id=" + id, '1300px', '900px');
 ...
 function view(id){//没有权限时，不显示确定按钮
      ...
      jp.openViewDialog('查看', "${ctx}/portal/news/form?id=" + id, '1300px', '900px');
