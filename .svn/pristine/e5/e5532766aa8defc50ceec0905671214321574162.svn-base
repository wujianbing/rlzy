					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-sm-2" >
								...
								<button  class="btn btn-default btn-sm"  onclick="jp.openSaveDialog('新建模块', '${ctx}/portal/newsModel/form','800px', '500px')">
		...
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="news" class="form form-horizontal well clearfix">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="title：">标题：</label>
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="新闻模块id：">模块：</label>
