...
Index.prototype = {
	...
	get : function() {
		...
		let dataDomainPieLeg = [ '1-20人', '20-50人', '50-100人', '100-500人',
				'500+人' ];
		...
		_self
				.pie_h("pie2", "企业规模分布", dataDomainPieLeg, dataDomainPieSer,
						"pie");
		_self.bar('bar1');
		_self.line('line1');
	},
	...
	pie_h : function(id, titName, dataLeg, dataSer, type) {
		...
		let option = {
			...
			color : [ '#318FC3', '#58C3C9', '#DBBE58', '#DA8C75', '#AA64BC',
					'#4BA29D', '#408E27' ],
			legend : {
				orient : 'horizontal',
				y : 340, // 延Y轴居中
	...
	line : function(id) {
		...
		let fzTime = [ '08:00', '10:00', '12:00', '14:00', '168:00', '18:00',
				'20:00', '22:00' ];
